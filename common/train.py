...
class Trainer:
    ...
    def __init__(self, GPU, data_dir, fixed_dir, fonts_num, batch_size, img_size):
        ...
        self.embeddings= init_embedding(embedding_num=56,embedding_dim=128)
...
if __name__=="__main__":
    trainer=Trainer(GPU=0, data_dir='./dataset-binary/',fixed_dir='./',fonts_num=56,batch_size=16,img_size=128)
    os.makedirs('./images',exist_ok=True)
    os.makedirs('./log',exist_ok=True)
    trainer.train(max_epoch=30,save_path='./images',to_model_path='./log',model_save_step=10,schedule=50)